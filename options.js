...
var tcDefaults = {
  ...
  skipVideoAds: true, // default: true
...
function save_options() {
  ...
  var skipVideoAds = document.getElementById('skipVideoAds').checked;
  var startHidden = document.getElementById('startHidden').checked;
  var controllerOpacity = document.getElementById('controllerOpacity').value;
  var blacklist = document.getElementById('blacklist').value;

  displayKeyCode = isNaN(displayKeyCode)
...
function restore_options() {
  chrome.storage.sync.get(tcDefaults, function(storage) {
    ...
    document.getElementById('skipVideoAds').checked = storage.skipVideoAds;
